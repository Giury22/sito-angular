...
const TRANSLATIONS = {
  it: {
    ...
    biglietti: {
      ...
      placeholderEmail: 'Es. mario@email.it',
    ...
    contatti: {
      ...
      // Sezione mappa
      doveTitolo: 'Dove ci troviamo',
      // Sezione info
      comeTitolo: 'Come contattarci',
      email: 'Email',
      telefono: 'Telefono',
      indirizzo: 'Indirizzo',
      orari: 'Orari di apertura',
      orariVal: 'Mar–Dom: 10:00 – 18:00 · Lunedì chiuso',
      // Sezione form
      formTitolo: 'Inviaci un messaggio',
      labelNome: 'Nome e cognome',
      labelEmail: 'Email',
      placeholderNome: 'Es. Mario Rossi',
      placeholderEmail: 'Es. mario@email.it',
      labelOggetto: 'Oggetto della richiesta',
      oggettoInfo: 'Informazioni generali',
      oggettoGruppi: 'Prenotazione gruppi / scuole',
      oggettoMostre: 'Mostre e eventi',
      oggettoAltro: 'Altro',
      labelTipo: 'Tipo di visitatore',
      tipoPrivato: 'Privato',
      tipoGruppo: 'Gruppo / classe scolastica',
      tipoStampa: 'Stampa / media',
      labelMessaggio: 'Messaggio',
      placeholderMessaggio: 'Scrivi qui la tua domanda o richiesta...',
      btnInvia: 'Invia messaggio',
      toastTitolo: 'Messaggio inviato!',
      toastMsg: 'Ti risponderemo entro 2 giorni lavorativi.',
      toastChiudi: 'Chiudi',
      erroreNome: 'Inserisci il tuo nome.',
      erroreEmail: 'Inserisci un indirizzo email valido.',
      erroreMessaggio: 'Scrivi un messaggio.',
      errorePrivacy: 'Devi accettare la privacy policy per inviare il modulo.',
      // Campo telefono opzionale nel form
      labelTelefonoForm: 'Telefono (opzionale)',
      placeholderTelefonoForm: 'Es. +39 333 1234567',
      // Checkbox consenso privacy
      labelPrivacy: 'Ho letto e accetto la ',
      labelPrivacyLink: 'privacy policy',
      // Sezione Come arrivare
      arrivoTitolo: 'Come arrivare',
      arrivoMetro: 'Metro',
      arrivoMetroVal: 'Linea A – Fermata San Giovanni, poi bus 87 o 218 (5 min)',
      arrivoAutobus: 'Autobus',
      arrivoAutobusVal: 'Linee 87, 218, 360 – Fermata Appia Nuova/Arco di Travertino',
      arrivoParcheggio: 'Parcheggio',
      arrivoParcheggioVal: 'Parcheggio gratuito in Via Lemonia; ZTL non attiva nel fine settimana',
    },
    // FOOTER
    footer: {
  ...
  en: {
    ...
    contatti: {
      ...
      // Map section
      doveTitolo: 'How to find us',
      // Info section
      comeTitolo: 'Get in touch',
      email: 'Email',
      telefono: 'Phone',
      indirizzo: 'Address',
      orari: 'Opening hours',
      orariVal: 'Tue–Sun: 10:00 – 18:00 · Closed on Mondays',
      // Form section
      formTitolo: 'Send us a message',
      labelNome: 'Full name',
      labelEmail: 'Email',
      placeholderNome: 'E.g. John Smith',
      placeholderEmail: 'E.g. john@email.com',
      labelOggetto: 'Subject',
      oggettoInfo: 'General information',
      oggettoGruppi: 'Group / school booking',
      oggettoMostre: 'Exhibitions and events',
      oggettoAltro: 'Other',
      labelTipo: 'Type of visitor',
      tipoPrivato: 'Individual',
      tipoGruppo: 'Group / school class',
      tipoStampa: 'Press / media',
      labelMessaggio: 'Message',
      placeholderMessaggio: 'Write your question or request here...',
      btnInvia: 'Send message',
      toastTitolo: 'Message sent!',
      toastMsg: 'We will reply within 2 business days.',
      toastChiudi: 'Close',
      erroreNome: 'Please enter your name.',
      erroreEmail: 'Please enter a valid email address.',
      erroreMessaggio: 'Please write a message.',
      errorePrivacy: 'You must accept the privacy policy to send the form.',
      // Optional phone field in form
      labelTelefonoForm: 'Phone (optional)',
      placeholderTelefonoForm: 'E.g. +39 333 1234567',
      // Privacy consent checkbox
      labelPrivacy: 'I have read and accept the ',
      labelPrivacyLink: 'privacy policy',
      // How to get here section
      arrivoTitolo: 'How to get here',
      arrivoMetro: 'Metro',
      arrivoMetroVal: 'Line A – San Giovanni station, then bus 87 or 218 (5 min)',
      arrivoAutobus: 'Bus',
      arrivoAutobusVal: 'Lines 87, 218, 360 – Stop Appia Nuova/Arco di Travertino',
      arrivoParcheggio: 'Parking',
      arrivoParcheggioVal: 'Free parking on Via Lemonia; ZTL not active on weekends',
    },
    // FOOTER
    footer: {
